function TrendingCard({ id, title, trendTitle, description, image, category }) {
    return (
        `<div class="trending__product swiper-slide" data-id='${id}' data-category='${category}'>
            <div class='trending__product-image'>
                <img src='${image}' alt='${title}'/>
            </div>
            <div class="trending__product-description">
                <div class="trending__product-text">
                    <h1 class="title">
                ...
                <div class="btn explore-more">
                    Explore more <span class="material-symbols-rounded">trending_flat</span>
                </div>
            </div>
        </div>`
    );
